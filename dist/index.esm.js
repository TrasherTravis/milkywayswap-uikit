...
var Icon$q = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React.createElement("image", { width: "32", height: "32", href: "/images/milkyway/logo.png" })));
};
...
var Icon$v = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React.createElement("image", { width: 90, height: 90, href: "/images/milkyway/9.png" })));
};
...
var SpinnerIcon = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 96 96" }, props),
        React.createElement("image", { width: "96", height: "96", href: "/images/milkyway/9.png" })));
};
...
var Logo = function (_a) {
    ...
    return (React.createElement(Svg, __assign({}, props),
        React.createElement("image", { height: "60px", href: isDark ? "/images/milkyway/LogoTextNewDark.png" : "/images/milkyway/LogoTextNewWhite.png" })));
};
...
var Logo$1 = function (_a) {
    ...
    var innerLogo = (React.createElement(React.Fragment, null,
        ...
        React.createElement(Logo, { className: "desktop-icon", isDark: isDark, height: "60px" })));
    return (React.createElement(Flex, { style: { alignItems: "center" } },
        React.createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? (React.createElement(Icon$L, { width: "24px", color: "hamburgerIcon" })) : (React.createElement(Icon$K, { width: "24px", color: "hamburgerIcon" }))),
        isAbsoluteUrl ? (React.createElement(StyledLink$1, { as: "a", href: href, "aria-label": "VIVA home page" }, innerLogo)) : (React.createElement(StyledLink$1, { to: href, "aria-label": "VIVA home page" }, innerLogo))));
};
